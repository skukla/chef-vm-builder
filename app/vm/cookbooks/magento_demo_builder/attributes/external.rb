...
default[:magento_demo_builder][:mysql][:db_password] =
	node[:mysql][:db_password]
...
default[:magento_demo_builder][:magento_patches][:holding_area] =
	node[:magento_patches][:holding_area]
