...
wysiwyg_directory = node[:magento_demo_builder][:samba][:share_list][:content_media_drop]
product_media_import_directory = node[:magento_demo_builder][:samba][:share_list][:product_media_drop]
