...
unless data_pack_list.empty?
  data_pack_list.each do |data_pack_key, data_pack_value|
    magento_demo_builder "Remove existing data for the #{data_pack_value['package_name']} data pack from the database" do
    ...
    magento_demo_builder "Build the #{data_pack_value['package_name']} data pack" do
    ...
    magento_demo_builder "Install data files into the #{data_pack_value['package_name']} data pack" do
