...
default[:magento_configuration][:admin_users] = {}
...
default[:magento_configuration][:paths] = if node[:magento_configuration][:magento_family] == 'enterprise'
                                            community_paths.concat(enterprise_paths)
                                          else
                                            community_paths
                                          end
