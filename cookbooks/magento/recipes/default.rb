...
apply_patches_flag = node[:magento][:patches][:apply]
apply_base_flag = node[:magento][:configuration][:flags][:base]
apply_b2b_flag = node[:magento][:configuration][:flags][:b2b]
configure_admin_users_flag = node[:magento][:configuration][:flags][:admin_users]
apply_custom_flag = node[:magento][:configuration][:flags][:custom_modules]
