...
custom_modules = node[:magento][:configuration][:flags][:custom_modules]
...
include_recipe "magento_custom_modules::configure" if !module_list.nil? && configure_custom_modules
